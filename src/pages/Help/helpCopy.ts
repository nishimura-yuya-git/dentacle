...
export const HELP_SECTIONS: HelpSection[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        paragraphs: [
          'いまは、院内で書き出した個人別全集計のCSVを、訪問スケジュールの種まきに使います。',
          'レセコン接続は導入に備えて、今から条件を固定しています。医院LANに入らないことが前提ではありません。VPNや閉域網、TLS 1.3以上のうち、許可した通り道だけを使います。データベースの接続ポートは開きません。',
          '取り込むのはカルテ番号、氏名、担当医、最終来院日、診療回数です。保険証やレセプトは取り込みません。初期は参照のみで、書き込みは、別契約があるときだけです。',
        ],
        links: [
